...
import { PokemonType, PokemonTypeDetails } from '@/types/common';
...
export default function calcDefendType(
  firstType: PokemonTypeDetails,
  secondType: PokemonTypeDetails,
): calcDefendTypeProps {
  ...
  // 0.25배와 0.5배 구분
  mergeAndCount(firstType.halfDamage, secondType.halfDamage).forEach((type) => {
