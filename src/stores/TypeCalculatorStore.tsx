...
import { calcResultType, PokemonTypeName, typeCalcMode } from '@/types/common';

interface TypeCalculatorState {
  mode: typeCalcMode;
  typeCalcDefendOptions: (PokemonTypeName | null)[];
  typeCalcAttackOptions: PokemonTypeName[] | null;
